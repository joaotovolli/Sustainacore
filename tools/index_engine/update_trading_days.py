...
from index_engine.db import upsert_trading_days
...
def update_trading_days(start_date: _dt.date | None = None) -> tuple[int, int, _dt.date]:
    load_default_env()
...
def main() -> int:
    ...
    inserted, total, latest = update_trading_days(start_date)
