"""Quota guard for worker CLI calls."""
...
LOGGER = logging.getLogger("gemini_jobs_worker.quota")

DEFAULT_STATE_PATH = "/var/lib/sustainacore/gemini_jobs_worker/quota_state.json"
FALLBACK_STATE_PATH = "/home/opc/Sustainacore/tools/gemini_jobs_worker/.state/quota_state.json"
...
class QuotaGuard:
    ...
    def _resolve_state_path(self) -> str:
        ...
        try:
            ...
            fallback_dir = os.path.dirname(FALLBACK_STATE_PATH)
