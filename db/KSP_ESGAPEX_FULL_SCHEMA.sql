--------------------------------------------------------
--  File created - Saturday-August-09-2025   
--------------------------------------------------------
DROP SEQUENCE "WKSP_ESGAPEX"."COMPANY_ID_SEQ";
DROP TABLE "WKSP_ESGAPEX"."CANDIDATE_USERS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."COMPANY_ESG_INPUTS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."COMPANY_ESG_INPUTS_LEVEL_1" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."CONTACT_US_MESSAGES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_BBALL" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_DEPT" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_EMP" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_GRADES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_ORDERS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_POPULATION" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_PRODUCTS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_PROJECTS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_SAMPLES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_SAMPLE_DATA" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_SAMPLE_NAMES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_STATS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_STOCKS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EBA_DEMO_CHART_TASKS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EEA_LIST_UPLOADED" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EEA_LIST_UPLOADED_OLD" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EEA_LIST_UPLOAD_DOWNLOAD" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EEA_LIST_UPLOAD_DOWNLOAD_OLD" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EEA_LIST_UPLOAD_PENDING" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EMEA_GREEN_BOND_ISS_PERC" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_ATTRIBUTION_DAILY" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_BENCHMARKS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_BENCHMARK_PRICES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_COMPANIES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_CONSTITUENT_PRICES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_DOCS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_INDEX_LEVELS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_METADATA" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_NEWS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."ESG_SCORES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EU_SDG_13_10_NET_GREENHOUSE_GAS_EMISSIONS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."EU_SDG_13_31_AVG_CO2_KM_NEW_PASSENGER_CARS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_ACTIONS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_BALANCE_SHEET" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_CASH_FLOW" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_COMPANIES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_CONSTITUENTS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_CONSTITUENT_PRICES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_DAILY_LEVELS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_DAILY_RETURNS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_DIVIDENDS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_ESG_SCORES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_FINANCIALS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_LEVELS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_REBALANCE_DATES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_SPLITS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."INDEX_STOCK_PRICES" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."TECH11_AI_GOV_ETH_INDEX" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_CHECKPOINTS" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_ROWID_VID_MAP" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_SHARED_JOURNAL_CHANGE_LOG" cascade constraints;
DROP TABLE "WKSP_ESGAPEX"."WDI_DATA" cascade constraints;
DROP VIEW "WKSP_ESGAPEX"."ESG_BENCHMARK_RETURNS";
DROP VIEW "WKSP_ESGAPEX"."ESG_BENCH_DAILY_RET";
DROP VIEW "WKSP_ESGAPEX"."ESG_BENCH_RISK_30D";
DROP VIEW "WKSP_ESGAPEX"."ESG_BENCH_SECTOR_DAILY";
DROP VIEW "WKSP_ESGAPEX"."ESG_INDEX_DAILY_RET";
DROP VIEW "WKSP_ESGAPEX"."ESG_INDEX_RETURNS";
DROP VIEW "WKSP_ESGAPEX"."ESG_INDEX_RISK_30D";
DROP VIEW "WKSP_ESGAPEX"."ESG_INDEX_SECTOR_DAILY";
DROP VIEW "WKSP_ESGAPEX"."ESG_INDEX_VS_BENCH_YTD";
DROP VIEW "WKSP_ESGAPEX"."ESG_SCORE_00";
DROP VIEW "WKSP_ESGAPEX"."ESG_SCORE_01";
DROP VIEW "WKSP_ESGAPEX"."ESG_SCORE_ENVIRONMENTAL";
DROP VIEW "WKSP_ESGAPEX"."ESG_SCORE_GOVERNANCE";
DROP VIEW "WKSP_ESGAPEX"."ESG_SCORE_SOCIAL";
DROP VIEW "WKSP_ESGAPEX"."NET_GREENHOUSE_GAS_EMISSIONS";
DROP VIEW "WKSP_ESGAPEX"."NET_GREENHOUSE_GAS_EMISSIONS_MAX_YEAR";
DROP VIEW "WKSP_ESGAPEX"."NET_GREENHOUSE_GAS_EMISSIONS_NEW";
DROP VIEW "WKSP_ESGAPEX"."TECH11_AI_GOV_ETH_PERF_00";
DROP PROCEDURE "WKSP_ESGAPEX"."EBA_DEMO_CHART_DATA";
DROP PROCEDURE "WKSP_ESGAPEX"."ESG_CALC_ATTRIBUTION";
DROP PROCEDURE "WKSP_ESGAPEX"."ESG_CALC_ATTRIBUTION_1Y";
DROP PROCEDURE "WKSP_ESGAPEX"."SC_CREATE_TABLE";
DROP PROCEDURE "WKSP_ESGAPEX"."SC_EXEC";
DROP PACKAGE "WKSP_ESGAPEX"."ESG_LLM";
DROP PACKAGE BODY "WKSP_ESGAPEX"."ESG_LLM";
DROP FUNCTION "WKSP_ESGAPEX"."ESG_LLM_ASK";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 LOB ("SUMMARY") STORE AS SECUREFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_CHECKPOINTS
--------------------------------------------------------

  CREATE TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_CHECKPOINTS" 
 ...
 LOB ("DATA") STORE AS SECUREFILE (
  ...
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) ;
--------------------------------------------------------
--  DDL for Table VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_ROWID_VID_MAP
--------------------------------------------------------

  CREATE TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_ROWID_VID_MAP" 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "DATA" ;
--------------------------------------------------------
--  DDL for Table VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_SHARED_JOURNAL_CHANGE_LOG
--------------------------------------------------------

  CREATE TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_SHARED_JOURNAL_CHANGE_LOG" 
   (	"USN" NUMBER, 
	"SLOT" NUMBER, 
	"SEQ" NUMBER, 
	"XCN" NUMBER, 
 ...
 VECTOR ("DATA_VECTOR") STORE AS (
  TABLESPACE "DATA"  CHUNK 8192 RETENTION MIN 1800) ;
--------------------------------------------------------
--  DDL for Table WDI_DATA
--------------------------------------------------------

  CREATE TABLE "WKSP_ESGAPEX"."WDI_DATA" 
   (	"COUNTRY_CODE" VARCHAR2(10 BYTE) COLLATE "USING_NLS_COMP", 
	"COUNTRY_NAME" VARCHAR2(100 BYTE) COLLATE "USING_NLS_COMP", 
	"INDICATOR_CODE" VARCHAR2(50 BYTE) COLLATE "USING_NLS_COMP", 
	"INDICATOR_NAME" VARCHAR2(200 BYTE) COLLATE "USING_NLS_COMP", 
	"YEAR" NUMBER(4,0), 
	"VALUE" NUMBER
   )  DEFAULT COLLATION "USING_NLS_COMP" SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 10 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  TABLESPACE "DATA"  ENABLE;
--------------------------------------------------------
--  Constraints for Table VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_CHECKPOINTS
--------------------------------------------------------

  ALTER TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_CHECKPOINTS" MODIFY ("CHECKPOINT_ID" NOT NULL ENABLE);
  ALTER TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_CHECKPOINTS" MODIFY ("LAYER" NOT NULL ENABLE);
  ALTER TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_CHECKPOINTS" MODIFY ("FLAG" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "DATA"  ENABLE;
--------------------------------------------------------
--  Constraints for Table VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_ROWID_VID_MAP
--------------------------------------------------------

  ALTER TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_ROWID_VID_MAP" ADD PRIMARY KEY ("BASE_TABLE_ROWID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA"  ENABLE;
--------------------------------------------------------
--  Constraints for Table VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_SHARED_JOURNAL_CHANGE_LOG
--------------------------------------------------------

  ALTER TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_SHARED_JOURNAL_CHANGE_LOG" MODIFY ("USN" NOT NULL ENABLE);
  ALTER TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_SHARED_JOURNAL_CHANGE_LOG" MODIFY ("SLOT" NOT NULL ENABLE);
  ALTER TABLE "WKSP_ESGAPEX"."VECTOR$ESG_DOCS_EMB_VIDX$165913_165965_0$HNSW_SHARED_JOURNAL_CHANGE_LOG" MODIFY ("SEQ" NOT NULL ENABLE);
--------------------------------------------------------
