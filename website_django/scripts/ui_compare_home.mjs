...
const capture = async ({ label, url, viewport, shots }) => {
  ...
  page.setDefaultNavigationTimeout(timeoutMs);
    ...
    await withTimeout(
      page.addStyleTag({
        content: "body{font-family: Arial, sans-serif !important;} *{animation:none !important; transition:none !important;} .page{display:none !important;} .tech100-home{display:none !important;} .hero__card{display:none !important;} .news-card{display:none !important;}",
      }),
      timeoutMs,
      ...
      for (const shot of shots) {
        ...
        if (shot.type === "full") {
          ...
          await withTimeout(
            page.screenshot({
              path: outPath,
              clip: { x: 0, y, width: viewport.width, height: Math.min(clipHeight, docHeight) },
              timeout: timeoutMs,
            }),
            timeoutMs + 1000,
