...
const screenshotDir = path.resolve(
  ...
  "docs",
  "screenshots",
  process.env.NEWS_SCREENSHOT_DIR || "news"
);
...
const requiredAfter = ["news_list.png", "news_detail.png"];
...
diffPair("news_list.png", "news_list.png", "diff_news_list.png");
diffPair("news_detail.png", "news_detail.png", "diff_news_detail.png");
