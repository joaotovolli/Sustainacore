...
TELEMETRY_RAW_RETENTION_DAYS = int(
    os.environ.get(
        "TELEMETRY_RAW_RETENTION_DAYS",
        os.environ.get("TELEMETRY_RETENTION_DAYS", "35"),
    )
)
TELEMETRY_RETENTION_DAYS = TELEMETRY_RAW_RETENTION_DAYS
TELEMETRY_AGGREGATE_RETENTION_DAYS = int(
    os.environ.get("TELEMETRY_AGGREGATE_RETENTION_DAYS", "400")
)
TELEMETRY_SESSION_RETENTION_DAYS = int(
    os.environ.get("TELEMETRY_SESSION_RETENTION_DAYS", str(max(35, TELEMETRY_RAW_RETENTION_DAYS)))
)
TELEMETRY_CONSENT_RETENTION_DAYS = int(
    os.environ.get("TELEMETRY_CONSENT_RETENTION_DAYS", "180")
)
...
TELEMETRY_STORE_LEGACY_EVENT_BLOBS = env_bool("TELEMETRY_STORE_LEGACY_EVENT_BLOBS", default=False)
TELEMETRY_LOG_SUCCESS_API_CALLS = env_bool("TELEMETRY_LOG_SUCCESS_API_CALLS", default=False)
