...
urlpatterns = [
    ...
    path("tech100/index/export/", tech100_index_views.tech100_index_export, name="tech100_index_export"),
    path("tech100/performance/export/", tech100_index_views.tech100_performance_export, name="tech100_performance_export"),
