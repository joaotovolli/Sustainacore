    ...
    *,
    ...
    return {
        ...
        "provider_readiness": {
            ...
            "daily_credit_used": context.get("provider_daily_used") or context.get("provider_usage_current"),
            "daily_credit_limit": context.get("provider_daily_limit") or context.get("provider_usage_limit"),
            "daily_credit_remaining": context.get("provider_daily_remaining") or context.get("provider_usage_remaining"),
            "daily_credit_safety_buffer": context.get("provider_daily_safety_buffer")
            or context.get("provider_credit_safety_buffer"),
            "minute_used": context.get("provider_minute_used"),
            "minute_limit": context.get("provider_minute_limit"),
            "minute_remaining": context.get("provider_minute_remaining"),
    ...
    *,
    ...
    report = {
        ...
        "operations": {
            ...
            "daily_credit_used": provider.get("daily_credit_used") or provider.get("provider_usage_current"),
            "daily_credit_limit": provider.get("daily_credit_limit") or provider.get("provider_usage_limit"),
            "daily_credit_remaining": provider.get("daily_credit_remaining")
            or provider.get("provider_usage_remaining"),
            "daily_credit_safety_buffer": provider.get("daily_credit_safety_buffer"),
            "minute_used": provider.get("minute_used"),
            "minute_limit": provider.get("minute_limit"),
            "minute_remaining": provider.get("minute_remaining"),
...
def format_pipeline_daily_report(report: Dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            f"- daily_credit_used: {operations.get('daily_credit_used', 'n/a')}",
            f"- daily_credit_limit: {operations.get('daily_credit_limit', 'n/a')}",
            f"- daily_credit_remaining: {operations.get('daily_credit_remaining', 'n/a')}",
            f"- daily_credit_safety_buffer: {operations.get('daily_credit_safety_buffer', 'n/a')}",
            f"- minute_used: {operations.get('minute_used', 'n/a')}",
            f"- minute_limit: {operations.get('minute_limit', 'n/a')}",
            f"- minute_remaining: {operations.get('minute_remaining', 'n/a')}",
